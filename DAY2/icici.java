...
public static void main(String[] args) throws Exception {
		...
		driver.findElement(By.id("MOBILENUM")).sendKeys("9121912131");
		driver.findElement(By.id("CUSTFIRSTNAME")).sendKeys("Shaik");
		driver.findElement(By.id("CUSTLASTNAME")).sendKeys("Rehana");
		...
		driver.findElement(By.id("DATEOFBIRTH")).sendKeys("10/02/1998");
